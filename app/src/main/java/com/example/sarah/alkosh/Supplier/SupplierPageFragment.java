...
public class SupplierPageFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.supplierpage_fragment,container,false);
        addbtn = (ImageButton) view.findViewById(R.id.myplacesbtn);
